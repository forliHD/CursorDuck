...
hinter deinem Mauszeiger her, pickt ihn ab und zu an, lässt sich streicheln — und macht
zwischendurch, was Enten eben so machen: gründeln, tauchen, putzen, baden, quaken, pennen.
...
| | |
|---|---|
| **Hinterherschwimmen** | Folgt dem Cursor mit Trägheit, schlängelt beim Paddeln, zieht Kielwasser und Bugwelle. Weit abgehängt? Dann sprintet sie. |
...
| **Anklicken** | Klick auf die Ente → sie quakt zurück. Doppelklick → Flügelschlagen. |
...
Spiegelung, Cursor-Picken, „Auf dieser Seite pausieren“ — alles greift sofort, ohne Neuladen.
Dazu neun Knöpfe, um Kunststücke direkt auszulösen.
...
src/engine.js          Schwimmphysik, Verhaltens-Automat, Streicheln, Küken, Sound
