...
| **Napping** | A while of quiet (15 seconds by default, adjustable from 5 to 60 in the popup) → head into the feathers, Zzz. Wakes up again with a “!”. |
...
the popup still do everything on request.
